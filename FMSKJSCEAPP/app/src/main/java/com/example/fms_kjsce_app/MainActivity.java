package com.example.fms_kjsce_app;
...
public class MainActivity extends AppCompatActivity{
    ...
    private static String webview_url   = "https://lms-kjsce.somaiya.edu/fmss/";    // web address or local file location you want to open in webview
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        webSettings.setUserAgentString("FMSS KJSCE");
